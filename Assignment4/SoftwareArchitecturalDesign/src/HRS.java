...
public class HRS{
  public static void main(String[] args) throws IOException{
    ...
    while(Framework.hasNextInstruction()){
      ...
      switch(next){
        case 1: 
          pw.print(MakeReservation.run(instructions)+"\n");
          break;
        case 2: 
          pw.print(CheckIn.checkIn(instructions)+"\n");
          break;
        case 3: 
          pw.print(CheckOut.checkOut(instructions)+"\n");
          break;
        case 4:
          pw.print(PrintManagementReport.viewReport(instructions)+"\n");
          break;
        case 5: 
